...
void Double_Motor_init(uint32 freq,float duty)
{
  ...
  ftm_pwm_finit(((FTM_Type *)(0x40038000u)), FTM_CH0, freq, duty);     
  ftm_pwm_finit(((FTM_Type *)(0x40038000u)), FTM_CH1, freq, duty); 
  
  ftm_pwm_finit(((FTM_Type *)(0x4003A000u)), FTM_CH0, freq, duty);     
  ftm_pwm_finit(((FTM_Type *)(0x4003A000u)), FTM_CH1, freq, duty); 
}
...
void Double_Motor_pwm_duty(float Left_motor_duty,float Right_motor_duty)
{
  ...
  if(Left_motor_duty>=0)
  {
      ...
      ftm_pwm_fduty(((FTM_Type *)(0x40038000u)), FTM_CH0, 0);
      ftm_pwm_fduty(((FTM_Type *)(0x40038000u)), FTM_CH1, Left_motor_duty);
  }
  else
  {
    if(Left_motor_duty<=-99)
    ...
    ftm_pwm_fduty(((FTM_Type *)(0x40038000u)), FTM_CH0, Left_motor_duty);
    ftm_pwm_fduty(((FTM_Type *)(0x40038000u)), FTM_CH1, 0);
  }
  if(Right_motor_duty>=0)
  {
      ...
      ftm_pwm_fduty(((FTM_Type *)(0x4003A000u)), FTM_CH0, Right_motor_duty);
      ftm_pwm_fduty(((FTM_Type *)(0x4003A000u)), FTM_CH1, 0);
  }
  else
  {
      if(Right_motor_duty<=-99)
      ...
      ftm_pwm_fduty(((FTM_Type *)(0x4003A000u)), FTM_CH0, 0);
      ftm_pwm_fduty(((FTM_Type *)(0x4003A000u)), FTM_CH1, Right_motor_duty);
  }
