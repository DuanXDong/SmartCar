...
int16 Tracking_ADC_Val_Temp_L[10];                       
int16 Tracking_ADC_Val_Temp_L_L[10];
int16 Tracking_ADC_Val_Temp_C[10]; 
int16 Tracking_ADC_Val_Temp_R_R[10];
int16 Tracking_ADC_Val_Temp_R[10];                      

uint16  Weighted_Ration[10]={4,6,7,8,10,15,20,30,200,700};      
uint16  Weighted_Ration_add=1000;                      
...
int32 Tracking_Sensor_data_L_record[10];                
...
int32 Tracking_ADC_Val_Sum_R=0;		                  
...
float point_center_record[10]={0};                        
...
float dianci_manage(void)
{
    ...
    Tracking_ADC_Val_Temp_L[9] = dianci_6();
    Tracking_ADC_Val_Temp_L_L[9] = dianci_4();
    Tracking_ADC_Val_Temp_C[9] = dianci_3();
    ...
    for(j=0;j<10;j++)
  {
   ...
   if((Tracking_Sensor_data_L-Tracking_Sensor_data_L_L>=90)&&(Tracking_Sensor_data_L>=180)&&RoundCenterStart_1==0)
   {
        RoundCenterStart_1=1;
       RoundCenterStart_L=1;
     led(LED0,LED_OFF);
   }
   if((Tracking_Sensor_data_R-Tracking_Sensor_data_R_R>=90)&&(Tracking_Sensor_data_R>=180)&&RoundCenterStart_1==0)
   {
     RoundCenterStart_1=1;
     RoundCenterStart_R=1;
     led(LED0,LED_OFF);
   }
   if((RoundCenterStart_L==1||RoundCenterStart_R==1)&&Tracking_Sensor_data_C>=180&&Tracking_Sensor_data_L>=180&&Tracking_Sensor_data_L_L>=180&&Tracking_Sensor_data_R_R>=180&&Tracking_Sensor_data_R>=180)
   {
   ...
   if(RoundCenterStart_L==1&&RoundCenterStart_2==1&&Tracking_Sensor_data_C<180)
   {
   ...
   if(RoundCenterStart_R==1&&RoundCenterStart_2==1&&Tracking_Sensor_data_C<180)
   {
     ...
     point_center=10000*Tracking_ADC_Val_Sub/Tracking_ADC_Val_Sum; 
   
   
     

    if(Tracking_Sensor_data_L==0&&Tracking_Sensor_data_R==0)
 {
