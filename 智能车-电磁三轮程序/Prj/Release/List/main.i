...
void  main(void)
{
    ...
    float dianci_Left,dianci_Right,dianci_Center,dianci_Left_L,dianci_Right_R;
    uint8 start=0;
    led_init(LED3);
    led_init(LED2);
    led_init(LED1);
    ...
    pit_init(PIT0,50 * bus_clk_khz);;                                
    NVIC_EnableIRQ(PIT_CH0_IRQn);                             

    systick_timing(10 * core_clk_khz);;                       
    
    Measurement_speed_init();
    ...
    while(1)
    {
        ...
        set_s_PID(2.3,2.23,0);                  
        set_d_PID(55,0,0.005);                  
        
        set_d_d_PID(0.01,0,0.02);
        ...
        dianci_Left = dianci_6();
        dianci_Left_L = dianci_4();
        dianci_Center = dianci_3();
        dianci_Right_R = dianci_2();
        dianci_Right = dianci_1();
        

          
          var[2] = dianci_Left_L;
          var[3] = (count_left+count_right)/2;
          var[4] = dianci_Right_R;
