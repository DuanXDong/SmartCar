 ...
 void  main(void)
{
    ...
    while(1)
    {
        if(start_f == 1)
        {
            ...
            switch(mode)
          {
            case 1: set_s_PID(2.0,1.85,0);                  
                    set_d_PID(0.10,0,0.5);                  
                    set_R_PID(0.039,0,0.95);
                    set_Speed(35);
            break;
            case 2:if(speed_flag==1)
                    {
                      set_s_PID(2.0,1.85,0);                  
                      set_d_PID(0.10,0,0.5);                  
        ...
        if(gpio_get(PTH4)==0)
        {
              site.x = 60;
              site.y = 10;
              lcd_num_bc(site, Tracking_Sensor_data_L,4, 0X001F, 0XF800);
        
              site.y = 30;
              lcd_num_bc(site, Tracking_Sensor_data_L_L,4, 0X001F, 0XF800);
        
              site.y = 50;
              lcd_num_bc(site, Tracking_Sensor_data_R_R,4, 0X001F, 0XF800);
                      
              site.y = 70;
              lcd_num_bc(site, Tracking_Sensor_data_R,4, 0X001F, 0XF800);
