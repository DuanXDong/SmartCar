...
void lcd_cross(Site_t site, uint16 len, uint16 Color)
{
    ...
    if (!((site . x < ST7735S_get_w()) && (site . y < ST7735S_get_h()))) assert_failed("D:\\Users\\PC-DCD\\Desktop\\\346\231\272\350\203\275\350\275\246-\347\224\265\347\243\201\344\270\211\350\275\256\347\250\213\345\272\217\\Board\\src\\VCAN_LCD.c", 87);   
