...
void AllInit()
{
    ...
    port_pull(PTE5,1);
    (*(kbi_init_t)((*((uint32_t *)((0x1A0) + (uint32)(&(((mydata_in_t *)0)->kbi_init))) ))))(PTE5, KBI_PULLUP_EN | KBI_FALLING) ;    
    soft_delay_ms(1);        
    (((((KBI_Type *)(0x4007A000u)))->SC) |= 0x4u | 0x20u );    
    NVIC_EnableIRQ((IRQn_t)(KBI0_IRQn + ((PTE5)>>5)));    
    ...
    site.x = 0;    
    site.y = 10;    
    lcd_str(site, "L:", 0X001F, 0XF800);    
  
    site.y = 30;    
    lcd_str(site, "L_L:", 0X001F, 0XF800);    
  
    site.y = 50;    
    lcd_str(site, "R_R:", 0X001F, 0XF800);    
  
    site.y = 70;    
    lcd_str(site, "R:", 0X001F, 0XF800);
    asm(" CPSIE i");;                   
}
